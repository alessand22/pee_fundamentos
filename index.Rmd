...
qqnorm(dados$resp[dados$argamassa == "Modificado"],
       main = "Modificado - Normal Q-Q plot")
qqline(dados$resp[dados$argamassa == "Modificado"])

qqnorm(dados$resp[dados$argamassa == "NaoMod"],
       main = "NaoMod - Normal Q-Q plot")
qqline(dados$resp[dados$argamassa == "NaoMod"])

# Valores padronizados
qqnorm(scale(dados$resp[dados$argamassa == "Modificado"]), main="Modificada padronizada - Normal Q-Q plot"); qqline(scale(dados$resp[dados$argamassa == "Modificado"]))

qqnorm(scale(dados$resp[dados$argamassa == "NaoMod"]),main="NaoMod padronizada - Normal Q-Q plot"); qqline(scale(dados$resp[dados$argamassa == "NaoMod"]))

# Histogramas
hist(scale(dados$resp[dados$argamassa == "Modificado"]), freq=FALSE, main = "Histograma de Argamassa Modificada")
...
hist(scale(dados$resp[dados$argamassa == "NaoMod"]), freq=FALSE, main = "Histograma de Argamassa Não Modificada")
